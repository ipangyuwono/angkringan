...
// OTP routes — outside dashboard, no otp.verified middleware
...
// Dashboard routes — protected by auth + OTP verification
Route::prefix('dashboard')->middleware(['auth', 'otp.verified'])->group(function () {
    ...
    // All authenticated + OTP-verified users
    ...
    Route::get('/my-kas', [KasController::class, 'myKas'])->name('kas.my');
});
